...
#define tracef(dlevel, grp, ...)                MBED_LOG(dlevel, grp, ##__VA_ARGS__)
#define vtracef(dlevel, grp, fmt, ap)           MBED_LOG_VSTR_1(MBED_STRINGIFY(dlevel), grp, MBED_STRINGIFY(fmt), ap)
...
#define mbed_trace_array(buf, len)
#define mbed_trace_ipv6(addr_ptr)
#define mbed_trace_ipv6_prefix(prefix, prefix_len)
