...
#define CODE_FLASH_START_NS         SECURE_ROM_SIZE
#define CODE_FLASH_SIZE_NS          (FSL_FEATURE_SYSCON_FLASH_SIZE_BYTES - SECURE_ROM_SIZE)
#define CODE_FLASH_START_NSC        (0x10000000 + SECURE_ROM_SIZE - 0x200)
#define CODE_FLASH_SIZE_NSC         0x200
#define DATA_RAM_START_NS           (0x20000000 + SECURE_RAM_SIZE)
#define DATA_RAM_SIZE_NS            (0x44000 - SECURE_RAM_SIZE)
...
*/
#define SAU_INIT_START0     CODE_FLASH_START_NS

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END0       (CODE_FLASH_START_NS + CODE_FLASH_SIZE_NS - 1)
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START1     DATA_RAM_START_NS

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END1       (DATA_RAM_START_NS + DATA_RAM_SIZE_NS - 1)
...
//     <o>Start Address <0-0xFFFFFFE0>
*/
#define SAU_INIT_START2     CODE_FLASH_START_NSC

/*
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END2       (CODE_FLASH_START_NSC + CODE_FLASH_SIZE_NSC - 1)
...
//     <o>End Address <0x1F-0xFFFFFFFF>
*/
#define SAU_INIT_END3       0x4010FFFF
