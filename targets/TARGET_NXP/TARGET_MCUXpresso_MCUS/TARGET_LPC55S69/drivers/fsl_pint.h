...
#endif
#if (FSL_FEATURE_SECURE_PINT_NUMBER_OF_CONNECTED_OUTPUTS > 0U)
    kPINT_SecPinInt0 = 8U, /*!< Pin Interrupt  8 */
#endif
#if (FSL_FEATURE_SECURE_PINT_NUMBER_OF_CONNECTED_OUTPUTS > 1U)
    kPINT_SecPinInt1 = 9U, /*!< Pin Interrupt  9 */
#endif
} pint_pin_int_t;
