...
void SPII2S_Reset(SPI_T *i2s) 
{
    /* Reset SPI/I2S */
    if(i2s == SPI1)
    {
        SYS_S->IPRST1 |= SYS_IPRST1_SPI1RST_Msk;
        SYS_S->IPRST1 &= ~SYS_IPRST1_SPI1RST_Msk;
    }
    else if(i2s == SPI2)
    {
        SYS_S->IPRST1 |= SYS_IPRST1_SPI2RST_Msk;
        SYS_S->IPRST1 &= ~SYS_IPRST1_SPI2RST_Msk;
    }
    else if(i2s == SPI3)
    {
        SYS_S->IPRST1 |= SYS_IPRST1_SPI3RST_Msk;
        SYS_S->IPRST1 &= ~SYS_IPRST1_SPI3RST_Msk;
    }
    else
    {
        SYS_S->IPRST2 |= SYS_IPRST2_SPI4RST_Msk;
        SYS_S->IPRST2 &= ~SYS_IPRST2_SPI4RST_Msk;
    }
}
#endif
